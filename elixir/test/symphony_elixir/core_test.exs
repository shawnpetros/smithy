defmodule SymphonyElixir.CoreTest do
  ...
  test "normal worker exit schedules active-state continuation retry" do
    ...
    retry_scheduled_after_ms = System.monotonic_time(:millisecond)
    ...
    assert_due_in_range(due_at_ms, retry_scheduled_after_ms, 500, 1_100)
  end
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_in_range(due_at_ms, retry_scheduled_after_ms, 39_500, 40_500)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_in_range(due_at_ms, retry_scheduled_after_ms, 9_000, 10_500)
  end
  ...
  defp assert_due_in_range(due_at_ms, scheduled_after_ms, min_remaining_ms, max_remaining_ms) do
    # Anchor to the monotonic instant before scheduling so scheduler delays
    # between the retry event and this assertion do not consume the window.
    remaining_ms = due_at_ms - scheduled_after_ms
