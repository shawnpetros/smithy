defmodule SymphonyElixir.CLITest do
  ...
  # Symphony no longer gates on a hold-harmless flag. The Smithy wrapper
  # prompts the operator on first registration and persists the
  # acknowledgement in ~/.smithy/config.toml. See wrapper/lib/smithy/.
