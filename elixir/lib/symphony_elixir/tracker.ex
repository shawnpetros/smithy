defmodule SymphonyElixir.Tracker do
  ...
  @callback fetch_issues_with_labels([String.t()]) :: {:ok, [term()]} | {:error, term()}
  @callback create_comment(String.t(), String.t()) :: :ok | {:error, term()}
  @callback update_issue_state(String.t(), String.t()) :: :ok | {:error, term()}
  @callback add_label(term(), String.t()) :: :ok | {:error, term()}
  @callback remove_label(term(), String.t()) :: :ok | {:error, term()}
  ...
  def fetch_issues_with_labels(label_names) when is_list(label_names) do
    adapter().fetch_issues_with_labels(label_names)
  end
